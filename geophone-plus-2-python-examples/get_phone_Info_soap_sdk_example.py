...
sys.path.insert(0, os.path.abspath("../geophone-plus-2-python/SOAP"))

from get_phone_Info_soap import GetPhoneInfoSoap


def get_phone_info_soap_sdk_go(is_live: bool, license_key: str) -> None:
    print("\n----------------------------------------------")
    print("GeoPhone Plus 2 - GetPhoneInfoInput - SOAP SDK")
    print("----------------------------------------------")
